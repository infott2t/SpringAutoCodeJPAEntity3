...
public class InsertHTMLContextStr {
    ...
    public String insertHTMLStr;

    public InsertHTMLContextStr(UtilStaticV4 usv) {
        ...
        this.insertHTMLStr = htmlUpTexting() + htmlIndexMiddleTexting()+ htmlDownTexting();
