...
public class ReadMeScreen extends JFrame {
    ...
    public ReadMeScreen(){
        ...
        jta.setText("" +
                ...
                "\n"+
                "* 텍스트 파일. Flat Save의 경우, 그냥 저장하고, save인 경우 아래의 부분이 추가되어서 저장됨니다. Now Entity에 엔티티이름을 적어주세요.\n"+
                "* Text file. If Flat Save button, just save, If save button, add follow columns, right this... . and Now Entity, writing entity name need.\n"+
                "Long id;\n" +
                "// Writing ..... Columns~.\n" +
                "// .........\n"+
                        "String isDel;\n" +
                ...
                " c:/category/ ... Making file. and Entity text file folder in.\n"+
                "\n"+
